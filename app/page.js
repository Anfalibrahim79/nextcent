      ...
      <section>
        ...
        <div className='w-full px-36 my-10 flex flex-col items-center gap-4 text-netral-D_Grey'>
          ...
          <div className='w-[1152px] h-[98px] flex justify-between items-center'>
            <Image src={'/logo/nLogo1.png'} width={40} height={40} alt='logo' />
            <Image src={'/logo/nLogo2.png'} width={40} height={28} alt='logo' />
            <Image src={'/logo/nLogo3.png'} width={55} height={30} alt='logo' />
            <Image src={'/logo/nLogo4.png'} width={47} height={29} alt='logo' />
            <Image src={'/logo/nLogo5.png'} width={41} height={27} alt='logo' />
            <Image src={'/logo/nLogo6.png'} width={52} height={20} alt='logo' />
            <Image src={'/logo/nLogo7.png'} width={55} height={30} alt='logo' />
          </div>
        </div>
        {/*Community */}
